...
const SERVICES: Record<string, ServiceData> = {
  "iphone-screen-repair": {
    ...
    descAr: "تصليح شاشة آيفون في المنزل خلال ساعة واحدة بفنيين معتمدين وضمان 12 شهراً. أسعار تنافسية لجميع موديلات آيفون في السعودية.",
    descEn: "Fix your iPhone screen at home in one hour with certified technicians and a 12-month warranty. Competitive prices for all iPhone models in Saudi Arabia.",
    ...
    subheadAr: "فني معتمد يصلك خلال ساعة، ضمان 12 شهراً على كل إصلاح",
    subheadEn: "A certified technician reaches you within an hour, 12-month warranty on every repair",
    ...
    faqAr: [
      ...
      { q: "هل تستخدمون قطع أصلية؟", a: "نعم، نستخدم قطع أصلية أو قطع عالية الجودة مضمونة لمدة 12 شهراً." },
    ...
    faqEn: [
      ...
      { q: "Do you use original parts?", a: "Yes, we use original or high-quality parts with a 12-month warranty." },
  ...
  "iphone-battery": {
    ...
    descAr: "تبديل بطارية آيفون في المنزل خلال 30 دقيقة بضمان 12 شهراً. فنيون معتمدون يصلونك أينما كنت في السعودية.",
    descEn: "Replace your iPhone battery at home in 30 minutes with a 12-month warranty. Certified technicians reach you anywhere in Saudi Arabia.",
    ...
    subheadAr: "بطارية أصلية وضمان 12 شهراً — الفني يصلك خلال ساعة",
    subheadEn: "Original battery with 12-month warranty — technician arrives within an hour",
    ...
    faqAr: [
      ...
      { q: "ما هي ضمانة البطارية الجديدة؟", a: "12 شهراً ضمان على البطارية والعمالة." },
    ],
    faqEn: [
      ...
      { q: "What is the warranty on the new battery?", a: "12-month warranty on both the battery and labor." },
    ],
  },
  "samsung-repair": {
    slug: "samsung-repair",
    ...
    descAr: "تصليح جوال سامسونج في المنزل بفنيين معتمدين. صيانة شاشة، بطارية، وكاميرا لجميع موديلات Galaxy بضمان 12 شهراً في السعودية.",
    descEn: "Samsung phone repair at home by certified technicians. Screen, battery, and camera repair for all Galaxy models with a 12-month warranty in Saudi Arabia.",
    ...
    subheadAr: "فني متخصص في Galaxy يصلك خلال ساعة — ضمان 12 شهراً",
    subheadEn: "Galaxy specialist reaches you in one hour — 12-month warranty",
  ...
  "laptop-repair": {
    ...
    descAr: "تصليح لابتوب في المنزل بفنيين معتمدين. إصلاح شاشة، بطارية، لوحة مفاتيح، وأكثر لجميع أنواع اللابتوب بضمان 12 شهراً في السعودية.",
    descEn: "Laptop repair at home by certified technicians. Screen, battery, keyboard and more for all laptop brands with 12-month warranty in Saudi Arabia.",
  ...
  "macbook-repair": {
    ...
    descAr: "تصليح ماك بوك في المنزل بفنيين معتمدين من Apple. إصلاح شاشة، بطارية، لوحة مفاتيح MacBook Air وMacBook Pro بضمان 12 شهراً في السعودية.",
    descEn: "MacBook repair at home by Apple-certified technicians. Screen, battery, keyboard repair for MacBook Air and MacBook Pro with 12-month warranty in Saudi Arabia.",
    ...
    subheadAr: "فنيون معتمدون من Apple يصلونك خلال ساعة — ضمان 12 شهراً",
    subheadEn: "Apple-certified technicians reach you in one hour — 12-month warranty",
  ...
  "ipad-repair": {
    ...
    titleAr: "تصليح آيباد",
    titleEn: "iPad Repair",
    descAr: "تصليح آيباد في المنزل خلال ساعة. إصلاح شاشة، بطارية، وزجاج iPad Air وPad Pro وiPad Mini بضمان 12 شهراً في السعودية.",
    descEn: "iPad repair at home within one hour. Screen, battery, and glass repair for iPad Air, iPad Pro, and iPad Mini with a 12-month warranty in Saudi Arabia.",
    ...
    subheadAr: "فني معتمد يصلك خلال ساعة — ضمان 12 شهراً على الشاشة والبطارية",
    subheadEn: "Certified technician reaches you within one hour — 12-month warranty on screen and battery",
