...
## استبدال الدوائر الملونة بلوجوهات الشركات

- [x] البحث عن لوجوهات الشركات عالية الجودة (Apple, Samsung, Huawei, Dell, HP, Lenovo)
- [x] تحويل اللوجوهات إلى PNG بخلفية شفافة (2000x2200, 2400x2400)
- [x] نسخ اللوجوهات إلى client/public/brands/
- [x] الكود يستخدم اللوجوهات بشكل صحيح (<img src="/brands/apple.png">)
- [ ] حل مشكلة Vite dev server cache (اللوجوهات الجديدة موجودة لكن المتصفح يعرض القديمة 200x200)
- [ ] رفع على GitHub واختبار على Render (بدون cache)
